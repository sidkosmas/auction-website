# on django shell 
#    $ exec(open('website/scripts/populate.py').read())
...
def run():
    ...
    # b = User.objects.create_user("dummy1", "dummy1@mail.com", "dummypassword")
    # b.last_name = "Dummy"
    # b.first_name = "One"
    # b.save()
    # b = UserDetails()
    ...
    # b.post_code = "35100"
    # b.country = "Dummcon"
    # b.user_id = User.objects.get(username="dummy1")
    # b.save()
    #
    # b = User.objects.create_user("dummy2", "dummy2@mail.com", "dummypassword")
    # b.last_name = "Dummy"
    # b.first_name = "Two"
    # b.save()
    # b = UserDetails()
    ...
    # b.post_code = "35100"
    # b.country = "Dummcon"
    # b.user_id = User.objects.get(username="dummy2")
    # b.save()
    #
    # b = User.objects.create_user("dummy3", "dummy3@mail.com", "dummypassword")
    # b.last_name = "Dummy"
    # b.first_name = "Three"
    # b.save()
    # b = UserDetails()
    ...
    # b.post_code = "35100"
    # b.country = "Dummcon"
    # b.user_id = User.objects.get(username="dummy3")
    # b.save()
    #
    # b = User.objects.create_user("dummy4", "dummy4@mail.com", "dummypassword")
    # b.last_name = "Dummy"
    # b.first_name = "Four"
    # b.save()
    # b = UserDetails()
    ...
    # b.post_code = "35100"
    # b.country = "Dummcon"
    # b.user_id = User.objects.get(username="dummy4")
    # b.save()
