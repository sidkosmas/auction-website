...
as used in the aiida documentation. View to see
...
Download: :download:`this example script <database.png>`
...
Here is an example of a reference to the which is on *another page*

Here is an example of a reference to something on the same page
...
==========================
An example of the table of contents syntax for the can be seen here
